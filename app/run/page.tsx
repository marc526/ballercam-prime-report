      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-gray-800 rounded-xl p-5 text-sm text-gray-400">
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>Wait ~6–8 min for all 10 locations to complete</li>
            <li>
